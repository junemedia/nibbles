...
if ($task == 'process') {
	if (trim($_COOKIE['security_code']) == $_POST['security_code'] && !empty($_COOKIE['security_code'])) {
		...
		//mail('spatel@amperemedia.com', $email_subject, $email_message);
    ...
    <div id="wrapper">
		...
		<div id="main_nav">
			<ul id="nav">
				...
				<li id="advertiser" class="here"><a href="advertiser_sign_up.php">advertiser sign up</a></li>
        ...
        <div id="content">
        	...
        	<div id="content_bot">
            	...
            	<div id="content_inner">
					...
					//echo getVar('advertiserText');
					?>
        			
                    <p>SilveriNet.com understands that helping you achieve the best results for your advertising dollars is crucial to any successful relationship. As one of the fastest-growing advertising networks today, we guarantee that the quality of our publishers, technology and account managers will make a significant contribution to the fulfillment of your marketing objectives.</p>

                    <p>With SilveriNet.com being just one of many innovative technologies that can help drive the traffic you need to succeed. We also have many newsletter publications as well as a complete co-registration system. Your offer does not have to just be in one place with us, but throughout our family of technology.</p>
                    
                    <p>Whether you're looking to achieve brand recognition, or generate leads and or sales, our extensive network of top-notch publishers can support the most aggressive objectives. Our team has carefully assessed our publishers to ensure that your campaign will be marketed appropriately.</p>
                    
                    <p>We provide prompt payment to Affiliates based on our real time reporting. At any time, you can log onto SilveriNet.com and retrieve customized activity reports. Your private, password-protected account allows you access to accurate tracking and reporting information that will help you improve your commissions and earning potential.</p>

                    <p>Please give us the following information so we can get in contact with you directly.</p>
                    ...
                    <div class="onecol">
                        ...
                        <p><label for="website">Website:</label> <input id="website" type="text" name="website" value="<?php echo $website; ?>" /></p>
