...
<table cellpadding=5 cellspacing=0 bgcolor=c9c9c9 width=95% align=center>
	...
	<!--	<tr><td>Categories To Include or Exclude</td>
		...
		<tr><td>&nbsp;</td></tr>
		<tr><td colspan=2><b>Note: </b>When a link is saved with the "Redirect to" option selected, and no entry is made into the "Redirect to" field, the default redurect URL will be used for foreign traffic.</td></tr>
		</tr>
