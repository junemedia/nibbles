...
//echo "\n\n\n***************************************** WARNING: MAKE SURE ESPEXPORT SCRIPT IS DONE BEFORE RUNNING THIS SCRIPT *********************************************\n\n\n";exit;
...
//	$deleteSubscribers = mysql_query("INSERT IGNORE INTO deleteSubscribers (email,listid) SELECT us.email,us.listid FROM joinEmailActive us LEFT JOIN joinEmailActiveArcamax they ON us.email=they.email AND us.listid=they.listid WHERE us.dateTime < CURDATE() AND they.email IS NULL");
