...
// send report, with # of bounced emails
$reportSubject = 'Grid Bounce (held) from skylist';
$reportHeaders = "From: grid-bounce@amperemedia.com\r\n";
$mailMessage .= "\n$totalHeld emails held from Grid\n\n";
$mailMessage .= "$totalInvalid blank or invalid emails were not put on hold.\n\n";
$mailMessage .= "Invalid lines:\n";
$mailMessage .= implode($invalidLines);
$sTempTotal = $totalHeld + $totalInvalid;
