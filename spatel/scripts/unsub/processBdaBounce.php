...
$reportSubject = 'Bda Bounce (held) from skylist';
$reportHeaders = "From: bda-bounce@amperemedia.com\r\n";
$mailMessage .= "\n$totalHeld emails held from BDA\n\n";
