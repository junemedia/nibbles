...
--PHP-mixed-$random_hash
Content-Type: text/csv; name=ytd_unsub_survey_dump.csv
...
mail("samirp@junemedia.com,leonz@junemedia.com", "YTD Unsub Survey Dump - $from_date to $to_date", $email_output, $headers);
