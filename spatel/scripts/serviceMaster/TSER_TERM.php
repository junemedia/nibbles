...
$sQuery = "SELECT * FROM nibbles.otData WHERE offerCode = 'TSER_TERM' AND howSent='rte'";
...
while ($sOtRow = mysql_fetch_object($sOtResult)) {
	$sXmlContent = "<?xml version='1.0' encoding='utf-8' standalone='no' ?>
		...
		<order>
		 <item>
		  <productName>Pest Evaluation</productName>
		  <property>
		   <name>adName</name>
		  ...
		  <comments>Primary Concern: [field2]</comments>
		</item>
		</order>
		</wshRequest>";
